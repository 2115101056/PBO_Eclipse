...
public class Dosen extends Manusia{
	...
	public Dosen(String nama, boolean jenisKelamin, String alamat, 
			String nip,String jabatan, String prodi, String jurusan, String fakultas) {
		super(nama, jenisKelamin, alamat); //memanggil data dari superclass (manusia)
		this.nip = nip;
		this.jabatan = jabatan;
		this.prodi = prodi;
		this.jurusan = jurusan;
