...
//		pgw1.printAllInfo();
		...
		Dosen dos = new Dosen("Agus",true,"Singaraja");
		dos.setNip("123");
		...
		Manusia A = new Pegawai ("Arya", true, "Jakarta"); //dibuat oleh pegawai namun hanya data manusia
		A.printAllInfo();
		
		System.out.println("");
		System.out.println("Pegawai 1");
		Pegawai pgw1 = new Pegawai("Pegawai1", false, "Denpasar"); //data manusia
